...
](https://docs.github.com/en/codespaces/the-githubdev-web-based-editor) (press <kbd>.</kbd>), a suggestion will appear to install our [extension](https://marketplace.visualstudio.com/items?itemName=DodonaLearningTechnologies.dodona-exercise-assistant).
...
](https://docs.github.com/en/codespaces/the-githubdev-web-based-editor) (druk op <kbd>.</kbd>), zal er een suggestie verschijnen om onze [extensie](https://marketplace.visualstudio.com/items?itemName=DodonaLearningTechnologies.dodona-exercise-assistant) te installeren.
